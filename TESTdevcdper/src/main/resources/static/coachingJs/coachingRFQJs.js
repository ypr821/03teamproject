...
$(function(){
	...
	$('.RFQBtn').click(function(){
		...
		//수정버튼 견적결과등록되면 비활성화
		//선택한 견적결과코드  null = true, not null = false
		var isNullCoachingRFQResultCode = (myCoachingList[indexNum].coachingRFQResult.coachingRFQResultCode == null);
		if(! isNullCoachingRFQResultCode){
			console.log("널체크...");
			$('#coachingRFQUpdate').attr('hidden',true);
		}
